package com.optum.ap.services.rest.service.soapWrap;
...
public abstract class SoapBaseWrap {

	private Logger logger = Logger.getLogger(SoapBaseWrap.class.getName());
	...
	public static void setServiceVersion(String serviceVersion) {
		SoapBaseWrap.serviceVersion = serviceVersion;
	}
	...
	public static void setServiceProvider(String serviceProvider) {
		SoapBaseWrap.serviceProvider = serviceProvider;
	}
